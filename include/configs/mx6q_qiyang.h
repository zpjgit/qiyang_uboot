...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
        ...
        "loadkernel=tftp ${kernel};mmc dev 3;mmc erase  0x800 0x2500; mmc write ${loadaddr} 0x800 0x2500\0"  \
        "machid=0xF94\0" \
...
#define CONFIG_SYS_PROMPT		"MX6Q QIYANG U-Boot > "
...
#define CONFIG_SERVERIP			192.168.1.73
